...
namespace SettingsPhotoController.Controllers
{
    ...
    public class SettingsDOBController : Controller
    {
        private readonly SettingsContext _context;

       public SettingsDOBController(SettingsContext context)
        {
            _context = context;
            ...
            public async Task<List<Settingslist>> GetById(int id)
            {
             ...
             [HttpPatch("{id}")]
                public IActionResult PhotoUpdate(int id, [FromBody] DOBlist item)
                {
                    ...
                    Console.WriteLine("reached patch in dob controller");
